...
public class AddPatientController implements Initializable {
    ...
    private class SaveTask extends Task<Object> {
        ...
        protected Object call() throws Exception {
            ...
            try {
                ps = EHospitalDB.getCon().prepareStatement("Insert Into PATIENT (Patient_Name,Admited_Date,Date_Of_Birth,Gender,Marital_Status,Address,City,"
    ...
    private void saveAction() {
        ...
        if (patientName.isEmpty() || phone.isEmpty() || address.isEmpty() || city.isEmpty() || diagnosis.isEmpty() || datePicker.getValue() == null
            ...
            EHospitalDialog.dialogAlert(Alert.AlertType.ERROR, "Please Fill All Requied Input", textAddress.getScene().getWindow());
        } else {
