...
public class EditDeathController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            textPatientName.textProperty().addListener((ObservableValue<? extends String> observable, String oldValue, String newValue) -> {
                try {
                    ps = EHospitalDB.getCon().prepareStatement("Select ID From PATIENT Where Patient_Name=?");
    ...
    /**
     * Display the selected Dead Patient Details to its component
     *
    ...
    private class EditTask extends Task<Object> {
        ...
        protected Object call() throws Exception {
            ...
            try {
                ps = EHospitalDB.getCon().prepareStatement("Update DEATH Set ID=?,Name=?,Date=?,Time=?,Course_Of_Death=?,Treatment=? Where Name=?");
