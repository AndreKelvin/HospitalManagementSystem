...
public class EditPatientTreatmentController implements Initializable {
    ...
    private class SaveEditTask extends Task<Object> {
        ...
        protected Object call() throws Exception {
            ...
            try {
                ...
                Platform.runLater(() -> {
                    EHospitalDialog.dialogAlert(Alert.AlertType.ERROR, "Database connection failure", textDiagnosis.getScene().getWindow());
                });
            }
    ...
    private void save() {
        try {
            ...
            if (comboTreat.getValue() == null || listView.getItems().isEmpty()) {
                ...
                SaveEditTask task = new SaveEditTask();
