...
public class UpdateProfileController extends UpdateProfile {
    ...
    public void saveUpdate() {
        try {
            ps = EHospitalDB.getCon().prepareStatement("Update PHARMACIST Set NAME=?,DATE_OF_BIRTH=?,GENDER=?,ADDRESS=?,CITY=?,PHONE=?,MARITAL_STATUS=?,"
                ...
                if (chooserImageFile != null) {
                    ...
                    try (OutputStream output = new FileOutputStream(System.getProperty("user.home") + File.separator + "PharmacistImage" + File.separator + chooserImageFile.getName())) {
                        int size;
                    ...
                    ps.setString(10, System.getProperty("user.home") + File.separator + "PharmacistImage" + File.separator + chooserImageFile.getName());
                    chooserImageFile = null;
                } else {
                    ps.setString(10, System.getProperty("user.home") + File.separator + "PharmacistImage" + File.separator + recentImage.getName());
                }
