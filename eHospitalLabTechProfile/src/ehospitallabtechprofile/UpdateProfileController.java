...
public class UpdateProfileController extends UpdateProfile {
    ...
    public void saveUpdate() {
        try {
            ps = EHospitalDB.getCon().prepareStatement("Update LABTECHNICIAN Set NAME=?,DATE_OF_BIRTH=?,GENDER=?,ADDRESS=?,CITY=?,PHONE=?,MARITAL_STATUS=?,"
                ...
                if (chooserImageFile != null) {
                    ...
                    try (OutputStream output = new FileOutputStream(System.getProperty("user.home") + File.separator + "LabTechnicianImage" + File.separator + chooserImageFile.getName())) {
                        int size;
                    ...
                    ps.setString(10, System.getProperty("user.home") + File.separator + "LabTechnicianImage" + File.separator + chooserImageFile.getName());
                    chooserImageFile = null;
                } else {
                    ps.setString(10, System.getProperty("user.home") + File.separator + "LabTechnicianImage" + File.separator + recentImage.getName());
                }
